        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h1>
              ...
              <TextGenerateEffect
                words="GILSON"
                className="text-5xl md:text-7xl lg:text-8xl font-bold m-0 leading-tight tracking-tighter text-blue-300"
                duration={0.5}
                speed={0.2}
                initialDelay={0.4}
              />
            ...
            <motion.p
              ...
              className="text-neutral-500 mb-8 max-w-md text-lg"
            >
              MSc Astronautics & Space Engineering student at the University Of Surrey.
            </motion.p>
            {/* <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
